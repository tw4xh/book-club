...
export default async function NewBookPage({
  ...
  return (
    <div className="mx-auto max-w-md">
      ...
      <form action={importBooksFromSheetAction} className="card mt-6 space-y-3 p-4">
      ...
      <AddBookForm
        ...
        labels={{
          ...
          fieldLocation: t("add.field.location"),
          fieldZip: t("add.field.zip"),
          zipPlaceholder: t("login.zipPlaceholder"),
          areaPlaceholder: t("login.areaPlaceholder"),
